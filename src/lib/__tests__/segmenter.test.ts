...
console.log("Expected 2 segments:", t1.length === 2 ? "PASS" : `FAIL (got ${t1.length})`);
...
console.log("Expected 2 segments:", t2.length === 2 ? "PASS" : `FAIL (got ${t2.length})`);

// Test 3: Spanish abbreviations
console.log("\n=== Test 3: Spanish abbreviations ===");
const t3 = segmentText("El Sr. García llegó tarde. La Dra. López lo atendió.", "es");
console.log("Result:", JSON.stringify(t3));
console.log("Expected 2 segments:", t3.length === 2 ? "PASS" : `FAIL (got ${t3.length})`);
...
console.log("Expected 2 segments:", t4.length === 2 ? "PASS" : `FAIL (got ${t4.length})`);

// Test 5: Paragraph breaks
console.log("\n=== Test 5: Paragraph breaks ===");
const t5 = segmentText("First paragraph.\n\nSecond paragraph.", "en");
console.log("Result:", JSON.stringify(t5));
console.log("Expected 2 segments:", t5.length === 2 ? "PASS" : `FAIL (got ${t5.length})`);
...
console.log("Expected 1 segment:", t6.length === 1 ? "PASS" : `FAIL (got ${t6.length})`);

// Test 7: Email addresses
console.log("\n=== Test 7: Email addresses ===");
const t7 = segmentText("Contact john@example.com for details. He will respond.", "en");
console.log("Result:", JSON.stringify(t7));
console.log("Expected 2 segments:", t7.length === 2 ? "PASS" : `FAIL (got ${t7.length})`);

// Test 8: Ellipsis
console.log("\n=== Test 8: Ellipsis ===");
const t8 = segmentText("He thought about it... and then decided. It was final.", "en");
console.log("Result:", JSON.stringify(t8));
console.log("Expected 2 segments:", t8.length === 2 ? "PASS" : `FAIL (got ${t8.length})`);

// Test 9: Multiple abbreviations in one sentence
console.log("\n=== Test 9: Multiple abbreviations ===");
const t9 = segmentText("Mr. and Mrs. Johnson visited Dr. Brown. They were happy.", "en");
console.log("Result:", JSON.stringify(t9));
console.log("Expected 2 segments:", t9.length === 2 ? "PASS" : `FAIL (got ${t9.length})`);

// Test 10: UTF-8 characters (Chinese, Japanese, accented)
console.log("\n=== Test 10: UTF-8 characters ===");
const t10 = segmentText("La economía global cambió. El año 2024 fue difícil.", "es");
console.log("Result:", JSON.stringify(t10));
console.log("Expected 2 segments:", t10.length === 2 ? "PASS" : `FAIL (got ${t10.length})`);
